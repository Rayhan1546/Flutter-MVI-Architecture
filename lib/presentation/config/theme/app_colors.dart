...
class AppColors {
  ...
  static const Color lightSecondaryContainer = Color(0xFFB3E5E5);
  ...
  // Dark theme colors
  static const Color darkPrimary = Color(0xFF4C9AFF);
  static const Color darkPrimaryContainer = Color(0xFF0D47A1);
  static const Color darkSecondary = Color(0xFF4DB6AC);
  static const Color darkSecondaryContainer = Color(0xFF00695C);
